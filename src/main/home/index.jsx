      ...
      <div className="main__content">
        ...
        <div className="main__content-right">
          <p>
            ...
            que permitió el desarrollo rápido de las Artes Marciales, llegaron a
            existir hasta 73 escuelas de ninjutsu con conocimientos de
          ...
          <p>
            Engloba técnicas cuerpo a cuerpo de golpeo, proyecciones, luxaciones
            y controles, técnicas con todo tipo de armas así como una parte más
            mental como meditación y canalización de la energía.
          </p>
          <div className="main__content-right__container">
            <div className="main__content-right__container-column">
              <p><u>Gimnasio</u></p>
              <a target="blank" href="https://www.clubtsunami.es/website/">Club Deportivo Tsunami</a>
            </div>
            <div className="main__content-right__container-column">
              <p><u>Nuestra asociación</u></p>
              <a target="blank" href="https://www.jmcollado.com/">Bujinkan Collado Dojo</a>
            </div>
            <div className="main__content-right__container-column">
              <p><u>Otros Dojos en Madrid</u></p>
              <a target="blank" href="https://es-es.facebook.com/people/Nin-Jutsu-Tres-Cantos/100050039177804/">Ninjutsu Tres Cantos</a>
              <a target="blank" href="https://es-la.facebook.com/ninjutsurivas/">Ninjutsu Rivas Vaciamadrid</a>
            </div>
            <div className="main__content-right__container-column">
              <p><u>Compra de Material</u></p>
              <a target="blank" href="https://fujimae.com/es/tiendas">Tienda de Material en Madrid</a>
              <a target="blank" href="https://www.budoya.es/">Budo YA artículos para Artes Marciales</a>
            </div>
          </div>
        </div>
      </div>
